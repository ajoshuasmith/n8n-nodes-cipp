	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				type: 'string',
				default: '',
				description: 'UPN or GUID of user to grant OneDrive access',
			},
			{
				...
				type: 'string',
				default: '',
				description: 'UPN or GUID of user to grant mailbox access with automapping',
			},
			{
				...
				type: 'string',
				default: '',
				description: 'UPN or GUID of user to grant mailbox access without automapping',
			},
		],
	},
