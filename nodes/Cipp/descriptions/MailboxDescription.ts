...
export const mailboxOperations: INodeProperties[] = [
	{
		...
		options: [
			...
			},
			{
				...
				description: 'Run Exchange message trace',
...
export const mailboxFields: INodeProperties[] = [
	...
	{
		displayName: 'Trace Filters',
		name: 'messageTraceFilters',
		type: 'collection',
		...
		options: [
			{
				...
				options: [
					...
					{ name: 'Start/End', value: 'startEnd' },
				],
				default: 'relative',
				description: 'Whether to use relative days or explicit start/end dates',
			},
			{
				displayName: 'Days',
				name: 'days',
				type: 'number',
				default: 7,
				description: 'Number of days for relative trace searches',
			},
			{
				...
				type: 'dateTime',
				default: '',
				description: 'End date/time for start/end trace searches',
			},
			{
				displayName: 'From IP',
				name: 'fromIP',
			...
			},
			{
				...
				type: 'dateTime',
				default: '',
				description: 'Start date/time for start/end trace searches',
			},
			{
				displayName: 'Status',
				name: 'status',
			...
			},
			{
				...
				type: 'string',
				default: '',
				description: 'Trace detail value',
			},
		],
	},
